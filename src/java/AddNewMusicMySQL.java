 ...
 * @author Mine
 */
@WebServlet(urlPatterns = {"/AddNewMusicMySQL"})
public class AddNewMusicMySQL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // insert into MySQL: table music
        DBConnection dbConnection = new DBConnection();
        if (!dbConnection.insertNewMusic(music)) {
            System.out.println(">>> AddNewMusicMySQL ERROR");
        }

        // forward to addNewMusicSuccess.jsp
